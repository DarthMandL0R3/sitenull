// Terminal typing animation for projects page
document.addEventListener('DOMContentLoaded', function() {
    var el = document.getElementById('github-terminal');
    if (!el || el.dataset.started) return;
    el.dataset.started = '1';
    
    var lines = [
        { type: 'command', text: 'github --stats' },
        { type: 'output', text: 'Public Repos: 15+' },
        { type: 'output', text: 'Contributions: 500+ this year' },
        { type: 'output', text: 'Top Languages: Python, Bash, YAML' },
        { type: 'command', text: 'echo $FOCUS' },
        { type: 'status', text: 'Azure automation, Kubernetes, Terraform' }
    ];
