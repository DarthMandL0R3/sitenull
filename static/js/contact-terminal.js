// Terminal typing animation for contact page
document.addEventListener('DOMContentLoaded', function() {
    var el = document.getElementById('contact-terminal');
    if (!el || el.dataset.started) return;
    el.dataset.started = '1';
    
    var lines = [
        { type: 'command', text: 'contact.sh --method all' },
        { type: 'output', text: 'Email: contact@abrarkhalish.com' },
        { type: 'output', text: 'GitHub: github.com/DarthMandL0R3' },
        { type: 'output', text: 'LinkedIn: linkedin.com/in/abrarkhalish' },
        { type: 'command', text: 'echo $STATUS' },
        { type: 'status', text: 'Open to opportunities and collaborations' }
    ];
